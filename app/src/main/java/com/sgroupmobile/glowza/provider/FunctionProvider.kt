...
object FunctionProvider {
    fun getFunctions() = listOf(
        FunctionItem(R.string.func_edit, R.drawable.ic_edit, FunctionType.EDIT,true),
        FunctionItem(R.string.func_camera, R.drawable.ic_camera, FunctionType.CAMERA,true),
        FunctionItem(R.string.func_my_photos, R.drawable.ic_image, FunctionType.IMAGE),
        FunctionItem(R.string.func_stitch, R.drawable.ic_photo_collage, FunctionType.PHOTO_COLLAGE),
        FunctionItem(R.string.func_photobooth, R.drawable.ic_photobooth, FunctionType.PHOTOBOOTH),
        FunctionItem(R.string.func_my_videos, R.drawable.ic_video, FunctionType.VIDEO)
    )
}